...
#       post dog_foods_url, params: {
#         token: @token,
#         dog_food: {
#           can: @dog_food.can,
#           cups: @dog_food.cups,
#           dog_id: @dog_food.dog_id,
#           food_type: @dog_food.food_type,
#           user_id: @dog_food.user_id
#         }
#       }, as: :json
#     end
#
...
#     get dog_food_url(@dog_food), params: {
#       token: @token
#     }
#     assert_response :success
#   end
